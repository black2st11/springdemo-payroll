...
public class Employee {
    ...
    Employee(String fistName,String lastName, String role){
    ...
    public String toString(){
        String format = String.format("Employee { id = %d, firstName = %s, lastName=%s, role = %s }", this.id, this.firstName, this.lastName, this.role);
        return format;
    }
}
